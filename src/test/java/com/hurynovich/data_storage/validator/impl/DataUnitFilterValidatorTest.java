...
class DataUnitFilterValidatorTest {
	...
	private final TestObjectGenerator<DataUnitSchemaDTO> schemaGenerator = new TestDataUnitSchemaDTOGenerator();
	...
	private List<DataUnitPropertyCriteria> buildCriteria() {
		return List.of(
				new DataUnitPropertyCriteria(DATA_UNIT_TEXT_PROPERTY_SCHEMA_ID, CriteriaComparison.CONTAINS, DATA_UNIT_TEXT_PROPERTY_VALUE),
				new DataUnitPropertyCriteria(DATA_UNIT_INTEGER_PROPERTY_SCHEMA_ID, CriteriaComparison.GT, DATA_UNIT_INTEGER_PROPERTY_VALUE),
				new DataUnitPropertyCriteria(DATA_UNIT_FLOAT_PROPERTY_SCHEMA_ID, CriteriaComparison.LE, DATA_UNIT_FLOAT_PROPERTY_VALUE),
				new DataUnitPropertyCriteria(DATA_UNIT_BOOLEAN_PROPERTY_SCHEMA_ID, CriteriaComparison.EQ, DATA_UNIT_BOOLEAN_PROPERTY_VALUE),
				new DataUnitPropertyCriteria(DATA_UNIT_DATE_PROPERTY_SCHEMA_ID, CriteriaComparison.LT, DATA_UNIT_DATE_PROPERTY_VALUE),
				new DataUnitPropertyCriteria(DATA_UNIT_TIME_PROPERTY_SCHEMA_ID, CriteriaComparison.GE, DATA_UNIT_TIME_PROPERTY_VALUE));
	}
	...
	void validateIncorrectComparisonPatternTest() {
		...
		final DataUnitFilter filter = new DataUnitFilter(schemaId, criteria);
		Mockito.when(schemaService.findById(schemaId)).thenReturn(Optional.of(schema));
		Mockito.when(valueCheckProcessor.processCheck(Mockito.any(DataUnitPropertySchemaDTO.class),
				Mockito.any(Object.class))).thenAnswer(invocation -> {
