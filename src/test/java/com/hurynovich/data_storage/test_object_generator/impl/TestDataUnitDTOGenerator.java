...
public class TestDataUnitDTOGenerator implements TestIdentifiedObjectGenerator<DataUnitDTO> {

	@Override
	public DataUnitDTO generateObject() {
		return generateDataUnit(DATA_UNIT_ID_1, DATA_UNIT_SCHEMA_ID_1);
	}

	@Override
	public DataUnitDTO generateObjectNullId() {
	...
	@Override
	public List<DataUnitDTO> generateObjects() {
		final DataUnitDTO dataUnit1 = generateDataUnit(DATA_UNIT_ID_1, DATA_UNIT_SCHEMA_ID_1);
		final DataUnitDTO dataUnit2 = generateDataUnit(DATA_UNIT_ID_2, DATA_UNIT_SCHEMA_ID_2);
		final DataUnitDTO dataUnit3 = generateDataUnit(DATA_UNIT_ID_3, DATA_UNIT_SCHEMA_ID_3);
